...
from .views import GetAllParcels, GetSpecificParcel, RemoveSpecificParcel, PostParcel, GetSpecificUserOrders, CreateUser, GetAllUsers
...
api.add_resource(RemoveSpecificParcel, '/parcels/<parcelId>/cancel')
